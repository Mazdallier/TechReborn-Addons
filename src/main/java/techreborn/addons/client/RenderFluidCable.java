...
public class RenderFluidCable {
    ...
    public static boolean renderStatic(Vecs3d translation, int pass, FluidCable part) {
        Tessellator tessellator = Tessellator.instance;
        IIcon texture = PartIconSupplier.fluidPipeIcon;
