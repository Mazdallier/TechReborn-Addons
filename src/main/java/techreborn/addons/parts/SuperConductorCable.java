...
import techreborn.addons.client.RenderSuperCable;
...
public class SuperConductorCable extends ModPart implements IPartDesc {
    ...
    public boolean renderStatic(Vecs3d translation, int pass) {
        return RenderSuperCable.renderStatic(translation, pass, this);
    }
    ...
    public void nearByChange() {
        ...
        for (ForgeDirection direction : ForgeDirection.VALID_DIRECTIONS) {
            ...
            if (part != null) {
                SuperConductorCable cablePart = (SuperConductorCable) part;
    ...
    public IModPart copy() {
        SuperConductorCable part = new SuperConductorCable();
        return part;
    }
    ...
    public boolean shouldConnectTo(TileEntity entity, ForgeDirection dir) {
        if (entity == null) {
            ...
            if (ModPartUtils.hasPart(entity.getWorldObj(), entity.xCoord, entity.yCoord, entity.zCoord, this.getName())) {
                SuperConductorCable otherCable = (SuperConductorCable) ModPartUtils.getPartFromWorld(entity.getWorldObj(), new Location(entity.xCoord, entity.yCoord, entity.zCoord), this.getName());
